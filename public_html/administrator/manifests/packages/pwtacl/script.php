...
class Pkg_PwtAclInstallerScript
{
	...
	private function cleanupSystemFiles()
	{
		...
		{
			$componentFiles = JFolder::files($folder, '.DS_Store', true, true, [], []);
    ...
    {
        $folders = [
            JPATH_PLUGINS . '/system/pwtacl/overrides/com_contact',
            JPATH_PLUGINS . '/system/pwtacl/overrides/com_content',
            JPATH_PLUGINS . '/system/pwtacl/overrides/com_modules',
        ];
