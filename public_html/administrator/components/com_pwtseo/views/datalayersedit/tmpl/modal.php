    ...
    <div class="pwtseo-datalayers container-fluid container-main">
        <div class="form-horizontal">
			<?php if (count($fieldSets)): ?>
				<?php echo HTMLHelper::_($cssPlatform . '.startTabSet', 'pwtseoTab', array('active' => $prefix . reset($fieldSets)->name)); ?>

				<?php foreach ($fieldSets as $fieldset): ?>
					<?php echo HTMLHelper::_($cssPlatform . '.addTab', 'pwtseoTab', $prefix . $fieldset->name, $fieldset->label); ?>
