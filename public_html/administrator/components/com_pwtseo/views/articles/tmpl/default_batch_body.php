...
<div class="form-horizontal">
	<?php echo HTMLHelper::_('bootstrap.startTabSet', 'tabs', array('active' => 'attrib-meta')); ?>


	<?php echo HTMLHelper::_('bootstrap.addTab', 'tabs', 'attrib-meta', Text::_('COM_PWTSEO_BATCH_META')); ?>
	...
	jQuery(document).ready(function () {
		...
		if ($sDescription && $sDescription.length) {
			$sDescription.on('keyup', function () {
				...
				if (this.value.length > <?php echo $params->get('count_max_metadesc',160); ?>) {
