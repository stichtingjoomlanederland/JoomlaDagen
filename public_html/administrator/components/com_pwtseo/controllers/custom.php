...
class PWTSEOControllerCustom extends FormController
{
	...
	public function batch($model = false)
	{
		...
		$model = BaseDatabaseModel::getInstance('Custom', 'PWTSEOModel', []);
		...
		$this->setRedirect(Route::_('index.php?option=com_pwtseo&view=customs' . $this->getRedirectToListAppend(), false));
