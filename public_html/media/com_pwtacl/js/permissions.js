...
jQuery(document).ready(function ($) {
	...
	$.fn.fixedHeader = function (options) {
		var config = {
			topOffset: parseInt($('.table-fixed-header').attr('data-offset'))
		};
	...
	$('[data-toggle=additional]').click(function (e) {
		e.preventDefault();
		$(this).toggleClass('js-open js-closed');

		if (this.getAttribute('data-target') === '#pwtaclall') {
			if ($(this).hasClass('js-open')) {
				$('.additional').show();
				$('[data-toggle=additional]').find('span').removeClass('icon-arrow-right').addClass('icon-arrow-down');
			}
			if ($(this).hasClass('js-closed')) {
				$('.additional').hide();
				$('[data-toggle=additional]').find('span').removeClass('icon-arrow-down').addClass('icon-arrow-right');
			}
		} else {
			$(this.getAttribute('data-target')).toggleClass('js-open js-closed');
