 ...
 * @since   3.0
 */
class PlgSystemPwtacl extends CMSPlugin
{
	/**
	 * Application object.
	 *
	...
	public function onAfterRoute()
	{
		...
		{
			$class = 'ContentModelArticles';
			$file = 'com_content/models/articles.php';
			$namespace = '';

			if (Version::MAJOR_VERSION === 4)
			{
				$class = 'ArticlesModel';
				$file = 'com_content/src/Model/ArticlesModel.php';
				$namespace = 'Joomla\Component\Content\Administrator\Model\\';
			}

			$this->overrideJoomlaCoreClass($class, $file, $namespace);
		}

		// Contact Manager overrides
		if ($aclContactOnlyEditable && $option === 'com_contact' && (($view === 'contacts') || (!$view)))
		{
			$class = 'ContactModelContacts';
			$file = 'com_contact/models/contacts.php';
			$namespace = '';

			if (Version::MAJOR_VERSION === 4)
			{
				$class = 'ContactsModel';
				$file = 'com_contact/src/Model/ContactsModel.php';
		...
		{
			$class = 'ModulesModelModules';
			$file = 'com_modules/models/modules.php';
			$namespace = '';

			if (Version::MAJOR_VERSION === 4)
			{
				$class = 'ModulesModel';
				$file = 'com_modules/src/Model/ModulesModel.php';
				$namespace = 'Joomla\Component\Module\Administrator\Model\\';
			}
	 ...
	 * @since   3.0
	 */
	private function overrideJoomlaCoreClass($class, $file, $namespace = '')
	{
		...
		if (!class_exists($class . 'Core', false))
		{
			...
			JLoader::register($namespace . $class, __DIR__ . '/overrides/' . Version::MAJOR_VERSION . '/' . $file);
			JLoader::load($namespace . $class);
		}
	}
